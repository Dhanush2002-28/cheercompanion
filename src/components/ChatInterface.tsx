...
const ChatInterface: React.FC = () => {
  ...
  return (
    <section id="chat" className="min-h-screen py-24 px-6 bg-gradient-radial from-white to-support-50/30">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12 reveal">
          <h2 className="text-3xl md:text-4xl font-light mb-4">Talk with our AI Companion</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Share your thoughts, celebrate victories, or find support during difficult times. 
            Our AI is here to listen without judgment.
          </p>
        </div>
            ...
            {messages.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center text-center text-muted-foreground p-6">
                <div className="mb-4 p-3 rounded-full bg-support-100">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-support-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
                  </svg>
                </div>
                <p className="text-sm mb-2">No messages yet</p>
                <p className="text-xs max-w-sm">
                  Share your thoughts, feelings, or experiences. The AI is here to provide emotional support.
                </p>
              </div>
            ) : (
          ...
          <form onSubmit={handleSubmit} className="p-4 border-t border-border">
            <div 
              className={`flex items-center rounded-lg border ${
                isFocused ? 'border-support-400 ring-2 ring-support-100' : 'border-border'
